...
namespace HawkAI.Migrations.DataDb
{
    ...
    [Migration("20260124212900_AddKPProjectTables")]
    partial class AddKPProjectTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HawkAI.Data.AirulerResultService.AirulerFilmMeasureResult", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AirulerFilmMeasureResults");
                });
            ...
            modelBuilder.Entity("HawkAI.Data.ProjectServiceKP.ImageEntryKP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HawkAI.Data.ProjectServiceKP.ProjectKP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HawkAI.Data.ProjectServiceKP.ImageEntryKP", b =>
                {
                    b.HasOne("HawkAI.Data.ProjectServiceKP.ProjectKP", "Project")
                        .WithMany("Images")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
